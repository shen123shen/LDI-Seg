...
class LDI_Seg(nn.Module):
    def __init__(self, out_planes=1, encoder='inceptionnext_tiny'):
        ...
        self.LFIU1 = LFF(mutil_channel[0], mutil_channel[1], mutil_channel[2], mutil_channel[3], lenn=1)
        self.LFIU2 = LFF(mutil_channel[0], mutil_channel[1], mutil_channel[2], mutil_channel[3], lenn=1)
        self.LFIU3 = LFF(mutil_channel[0], mutil_channel[1], mutil_channel[2], mutil_channel[3], lenn=1)
        ...
        self.fu1 = DSE(96, 192,  96)
        self.fu2 = DSE(192, 384, 192)
        self.fu3 = DSE(384, 768,  384)
    def forward(self, x):
