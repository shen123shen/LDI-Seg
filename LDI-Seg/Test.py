...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_model', type=str,
                        default='/home/ta/Project/LDI-Seg/result' + model_name + '/')

    parser.add_argument('--pth_path', type=str,
                        default='/home/ta/Project/MGFI_Net/result/ISIC2018/LDI-Seg/rank_1.pth')

    opt = parser.parse_args()

    logging.basicConfig(filename='/home/ta/Project/MGFI_Net/test/log/ISIC2018/LDI-Seg.log',
